...
watch-admin: ## starts watcher for Shopware 6.4.14.0 Admin at http://localhost:8888
...
# ---------------------------------------------------------------------------------------------
create-notificationTable: ## create a migration
    bin/console database:create-migration -p NotifyOnStock --name NotificationTable
